...
def make_env_from_name(
    env_name, seed=None, return_gym_env=False, return_gym_vec_env=False, num_envs_vec=1, num_discrete_actions=2
):
    """
    ...
    if env_name in gymnax.registered_envs:
        ...
        elif env_name == "Pendulum-v1-BangBang":
            from .environments.pendulum_bangbang import PendulumBangBang

            env = PendulumBangBang(num_actions=num_discrete_actions)
